...
public class MyScrumTeam {
    public static void main(String[] args) {
        //+ testers //4 developers // 1 scrum team
        ...
        Developer developer3=new Developer("Tunç",28 , "Software Developer",135000);
        Developer developer4=new Developer("Sinem",282 , "Java Developer",125000);
        Developer developer5=new Developer("Olga",13 , "Denior Developer",200000);
